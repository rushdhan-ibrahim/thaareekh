 ...
 * Mirror of apps/web/src/audio/audio-maps.ts.
 */

/** Pentatonic anchor pitches per dynasty (Hz) — consonant under overlap. */
export const DYNASTY_PITCH = {
  lunar: 392.0, // G4
  hilaaly: 440.0, // A4
  utheemu: 493.88, // B4
...
export function dynastyPitch(key) {
