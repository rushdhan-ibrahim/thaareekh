...
const D: Record<Locale, TranslationDict> = {
  en: {
    ...
    kin_header: 'Kin',
    story: 'Chronicle',
    evidence_links_total: 'documented links',
    evidence_sources_total: 'Distinct sources',
    evidence_strength: 'Evidence strength',
    geographic_context: 'Geographic context',
    held_offices: 'Offices held',
    historical_context: 'Historical context',
    holders_word: 'holders',
    inference_direct_claim_missing: 'No direct claim found in the cited sources; this relationship is modeled.',
    inference_grade_audience_a: 'strong primary support',
    inference_grade_audience_b: 'solid secondary support',
    inference_grade_audience_c: 'limited corroboration',
    inference_grade_audience_d: 'contested or weak support',
    inference_grade_audience_unknown: 'ungraded',
    inference_how_link: 'How this inference works',
    inference_narrative_aunt_uncle: 'Modeled as aunt/uncle and niece/nephew.',
    inference_narrative_aunt_uncle_via: 'Modeled as aunt/uncle and niece/nephew via {via}.',
    inference_narrative_cousin: 'Modeled as cousins.',
    inference_narrative_cousin_via_parents: 'Modeled as cousins through {p1} and {p2}.',
    inference_narrative_generic: 'Modeled from adjacent documented relationships.',
    inference_narrative_grandparent: 'Modeled as grandparent and grandchild.',
    inference_narrative_grandparent_via: 'Modeled as grandparent and grandchild via {via}.',
    inference_narrative_sibling: 'Modeled as siblings.',
    inference_narrative_sibling_shared_parent: 'Modeled as siblings through {parent}.',
    inference_rule_children_of_siblings_plain: 'their parents are siblings',
    inference_rule_children_of_siblings_plain_named: '{a} and {b} are children of siblings',
    inference_rule_parent_of_parent_plain: 'a parent of a parent',
    inference_rule_parent_of_parent_plain_named: '{a} is a parent of {b}\u2019s parent',
    inference_rule_parent_sibling_plain: 'a sibling of a parent',
    inference_rule_parent_sibling_plain_named: '{a} is a sibling of {b}\u2019s parent',
    inference_rule_shared_parent_plain: 'a shared parent',
    inference_rule_shared_parent_plain_named: '{a} and {b} share a parent',
    inference_step_kin: '{a} is kin to {b}',
    inference_step_parent: '{a} is a parent of {b}',
    inference_step_sibling: '{a} is a sibling of {b}',
    inference_step_sources_support: 'cited sources lend support',
    inference_step_spouse: '{a} is a spouse of {b}',
    inference_step_start: 'starting from',
    inference_step_still_inferred: 'remains inferred pending direct evidence',
    inference_support_level: 'Support',
    inference_technical_trace: 'Technical trace',
    inference_why_relation: 'Why this relationship is shown',
    life_birth_conflict: 'Biography suggests birth {bio}; life data records {life}.',
    life_consistency: 'Life-data consistency',
    life_consistency_hint: 'Birth and death years cross-checked against the biography.',
    life_consistency_ok: 'No conflicts detected.',
    life_death_conflict: 'Biography suggests death {bio}; life data records {life}.',
    life_marker_bio: 'from biography',
    life_marker_est: 'estimated',
    no_held_offices: 'No recorded offices.',
    no_holders: 'No recorded holders.',
    office_alt_names: 'Also rendered as',
    office_function_evolution: 'Function through the eras',
    office_holders: 'Recorded holders',
    office_summary: 'Summary',
    office_word: 'office',
    offices_in_era: 'Offices in this era',
    periods_documented: 'periods documented',
    verification_canonical_decision: 'Canonical decision',
    verification_claim_id: 'Claim',
    verification_loading: 'Consulting the verification ledger\u2026',
    verification_not_indexed: 'Not yet indexed in the verification ledger.',
    ...
    verification_review_status: 'Review status',
    verification_reviewer: 'Reviewer',
    verification_status: 'Status',
    offices_roles: 'Offices',
    reign_abbrev: 'r.',
