...
Edge key: `kin|P199|P150|aunt/uncle↔niece/nephew`  
...
- Pair summary: P199 Abbas Ibrahim and P150 Dunya Maumoon are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P149 Nasreena Ibrahim, P199 Abbas Ibrahim) plus parent(P149 Nasreena Ibrahim, child) yields inferred aunt/uncle-line kin between P199 Abbas Ibrahim and P150 Dunya Maumoon.
...
- Primary inferred claim row: CLM-0088
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p150-p199-aunt-uncle-niece-nephew.md).
