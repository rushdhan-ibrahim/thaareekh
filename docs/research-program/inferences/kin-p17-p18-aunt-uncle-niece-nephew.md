...
Edge key: `kin|P17|P18|aunt/uncle↔niece/nephew`  
Last updated: `2026-02-10`  
Inference class: `rule-derived`

## 1) Edge identity
- Relation type: kin
- Source node: P17 Davud (Sundhura Bavana)
...
- Pair summary: P17 Davud (Sundhura Bavana) and P18 Omar Veeru (Loka Abarana) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P16 Salis (Meesuvvara), P17 Davud (Sundhura Bavana)) plus parent(P16 Salis (Meesuvvara), child) yields inferred aunt/uncle-line kin between P17 Davud (Sundhura Bavana) and P18 Omar Veeru (Loka Abarana).
...
- Primary inferred claim row: CLM-0480
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p17-p18-aunt-uncle-niece-nephew.md.
