...
Edge key: `kin|P31|P207|aunt/uncle↔niece/nephew`  
...
- Pair summary: P31 Ibrahim (Dhammaru Veeru) and P207 Recca are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
2. Supporting edge: parent P40 Aboobakuru (Bavana Sooja) -> P207 Recca (CLM-0598, SRC-MRF-HILAALY, grade B); excerpt: Direct parent relation recorded between Aboobakuru as parent of Recca.
3. Rule application (parent-sibling-aunt-uncle): sibling(P40 Aboobakuru (Bavana Sooja), P31 Ibrahim (Dhammaru Veeru)) plus parent(P40 Aboobakuru (Bavana Sooja), child) yields inferred aunt/uncle-line kin between P31 Ibrahim (Dhammaru Veeru) and P207 Recca.
...
- Primary inferred claim row: CLM-0499
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p207-p31-aunt-uncle-niece-nephew.md.
