...
Edge key: `kin|P150|P198|aunt/uncle↔niece/nephew`  
...
- Pair summary: P150 Dunya Maumoon and P198 Ilyas Ibrahim are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P149 Nasreena Ibrahim, P198 Ilyas Ibrahim) plus parent(P149 Nasreena Ibrahim, child) yields inferred aunt/uncle-line kin between P150 Dunya Maumoon and P198 Ilyas Ibrahim.
