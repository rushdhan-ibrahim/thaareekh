...
3. Rule application (parent-sibling-aunt-uncle): sibling(P52 Yoosuf (Veeru Aanandha), P50 Ibrahim (Bavana Furasuddha)) plus parent(P52 Yoosuf (Veeru Aanandha), child) yields inferred aunt/uncle-line kin between P50 Ibrahim (Bavana Furasuddha) and P55 Hassan (Singa Veeru).
