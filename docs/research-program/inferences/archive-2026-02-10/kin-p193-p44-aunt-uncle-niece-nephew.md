...
Edge key: `kin|P193|P44|aunt/uncle↔niece/nephew`  
...
- Pair summary: P193 Princess Recca and P44 Mohamed (Bavana Abarana) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P41 Hadi Hassan (Raadha Veeru), P193 Princess Recca) plus parent(P41 Hadi Hassan (Raadha Veeru), child) yields inferred aunt/uncle-line kin between P193 Princess Recca and P44 Mohamed (Bavana Abarana).
...
- Primary inferred claim row: CLM-0133
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p193-p44-aunt-uncle-niece-nephew.md).
