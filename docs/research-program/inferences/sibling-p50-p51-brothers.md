...
3. - sibling P47 Hassan (Raadha Aanandha) <-> P51 Kalu Mohamed (Dhammaru Bavana) [half-brothers] (CLM-0639, SRC-ROYALARK-MALDIVES)
...
5. Current modeling choice remains `inferred` because explicit source wording that names `sibling` for P50 Ibrahim (Bavana Furasuddha) and P51 Kalu Mohamed (Dhammaru Bavana) is still absent.
