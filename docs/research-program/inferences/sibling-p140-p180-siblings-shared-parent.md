...
Edge key: `sibling|P140|P180|siblings (shared parent)`  
...
- Pair summary: P140 Al-Nabeel Karayye Hassan Didi and P180 Princess Aishath Didi are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P130 Prince Ibrahim Faamuladheyri Kilegefaanu, P140 Al-Nabeel Karayye Hassan Didi and P180 Princess Aishath Didi are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0387
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p140-p180-siblings-shared-parent.md).
