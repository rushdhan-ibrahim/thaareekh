...
- Primary inferred claim row: CLM-0132
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p193-p39-aunt-uncle-niece-nephew.md).
