...
Edge key: `kin|P125|P128|grandparent`  
...
- Pair summary: P125 Meera Laila Nasheed and P128 Abida Mohamed are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P122 Mohamed Nasheed and P122 Mohamed Nasheed -> target parent links, P125 Meera Laila Nasheed is modeled as inferred grandparent-line kin of P128 Abida Mohamed.
...
- Primary inferred claim row: CLM-0051
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p125-p128-grandparent.md).
