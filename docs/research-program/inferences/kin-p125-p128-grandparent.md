...
Edge key: `kin|P128|P125|grandparent`  
...
- Pair summary: P128 Abida Mohamed and P125 Meera Laila Nasheed are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P122 Mohamed Nasheed and P122 Mohamed Nasheed -> target parent links, P128 Abida Mohamed is modeled as inferred grandparent-line kin of P125 Meera Laila Nasheed.
