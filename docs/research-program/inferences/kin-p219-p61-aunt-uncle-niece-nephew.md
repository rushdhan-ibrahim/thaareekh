...
Edge key: `kin|P219|P61|aunt/uncle↔niece/nephew`  
...
- Pair summary: P219 Umar Ma'afai Kilege and P61 Hassan IX / Dom Manoel (Dhirikusa Loka) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P220 Ahmad Manikufa'anu Kalaminja, P219 Umar Ma'afai Kilege) plus parent(P220 Ahmad Manikufa'anu Kalaminja, child) yields inferred aunt/uncle-line kin between P219 Umar Ma'afai Kilege and P61 Hassan IX / Dom Manoel (Dhirikusa Loka).
...
- Primary inferred claim row: CLM-0545
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p219-p61-aunt-uncle-niece-nephew.md.
