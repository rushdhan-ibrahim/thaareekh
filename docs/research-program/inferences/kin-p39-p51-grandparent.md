...
Edge key: `kin|P39|P51|grandparent`  
...
- Pair summary: P39 Yoosuf (Loka Aananadha) and P51 Kalu Mohamed (Dhammaru Bavana) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P46 Omar (Loka Sundhura) and P46 Omar (Loka Sundhura) -> target parent links, P39 Yoosuf (Loka Aananadha) is modeled as inferred grandparent-line kin of P51 Kalu Mohamed (Dhammaru Bavana).
...
- Primary inferred claim row: CLM-0156
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p39-p51-grandparent.md).
