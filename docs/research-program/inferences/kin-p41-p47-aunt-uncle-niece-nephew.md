...
Edge key: `kin|P41|P47|aunt/uncle↔niece/nephew`  
...
- Pair summary: P41 Hadi Hassan (Raadha Veeru) and P47 Hassan (Raadha Aanandha) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
2. Supporting edge: parent P46 Omar (Loka Sundhura) -> P47 Hassan (Raadha Aanandha) (CLM-0341, SRC-MRF-KINGS, grade B); excerpt: Maldives Kings List family/genealogy content lists P46 Omar as parent of P47 Hassan.
3. Rule application (parent-sibling-aunt-uncle): sibling(P46 Omar (Loka Sundhura), P41 Hadi Hassan (Raadha Veeru)) plus parent(P46 Omar (Loka Sundhura), child) yields inferred aunt/uncle-line kin between P41 Hadi Hassan (Raadha Veeru) and P47 Hassan (Raadha Aanandha).
...
- Primary inferred claim row: CLM-0559
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p41-p47-aunt-uncle-niece-nephew.md.
