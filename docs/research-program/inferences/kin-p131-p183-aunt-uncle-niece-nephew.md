...
Edge key: `kin|P131|P183|aunt/uncle↔niece/nephew`  
...
- Pair summary: P131 Mohamed Didi and P183 Ganduvaru Hassan Didi are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P180 Princess Aishath Didi, P131 Mohamed Didi) plus parent(P180 Princess Aishath Didi, child) yields inferred aunt/uncle-line kin between P131 Mohamed Didi and P183 Ganduvaru Hassan Didi.
...
- Primary inferred claim row: CLM-0068
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p131-p183-aunt-uncle-niece-nephew.md).
