...
Edge key: `kin|P211|P67|aunt/uncle↔niece/nephew`  
...
- Pair summary: P211 Dona Leonor de Malvidas and P67 Philippe’ (Keerithi Maha Radun) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P66 Joao’ (Keerithi Maha Radun), P211 Dona Leonor de Malvidas) plus parent(P66 Joao’ (Keerithi Maha Radun), child) yields inferred aunt/uncle-line kin between P211 Dona Leonor de Malvidas and P67 Philippe’ (Keerithi Maha Radun).
...
- Primary inferred claim row: CLM-0527
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p211-p67-aunt-uncle-niece-nephew.md.
