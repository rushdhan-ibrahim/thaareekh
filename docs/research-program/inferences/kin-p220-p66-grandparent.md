...
Edge key: `kin|P220|P66|grandparent`  
...
- Pair summary: P220 Ahmad Manikufa'anu Kalaminja and P66 Joao’ (Keerithi Maha Radun) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P61 Hassan IX / Dom Manoel (Dhirikusa Loka) and P61 Hassan IX / Dom Manoel (Dhirikusa Loka) -> target parent links, P220 Ahmad Manikufa'anu Kalaminja is modeled as inferred grandparent-line kin of P66 Joao’ (Keerithi Maha Radun).
...
- Primary inferred claim row: CLM-0552
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p220-p66-grandparent.md.
