...
Edge key: `sibling|P208|P219|siblings (shared parent)`  
...
- Pair summary: P208 Princess Aysha Rani Kilege and P219 Umar Ma'afai Kilege are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P51 Kalu Mohamed (Dhammaru Bavana), P208 Princess Aysha Rani Kilege and P219 Umar Ma'afai Kilege are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0619
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/sibling-p208-p219-siblings-shared-parent.md.
