...
- Pair summary: P41 Hadi Hassan (Raadha Veeru) and P193 Princess Recca are modeled as inferred kin (cousins) through rule `children-of-siblings-cousin`.
...
5. Rule application (children-of-siblings-cousin): children of sibling parents P39 Yoosuf (Loka Aananadha) and P40 Aboobakuru (Bavana Sooja) are modeled as inferred cousin-line kin (P41 Hadi Hassan (Raadha Veeru) <-> P193 Princess Recca).
...
- Primary inferred claim row: CLM-0483
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p193-p41-cousins.md.
