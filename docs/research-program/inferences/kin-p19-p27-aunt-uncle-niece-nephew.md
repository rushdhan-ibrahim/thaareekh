...
- Pair summary: P19 Ahmed Shihabuddine (Loka Aadheeththa) and P27 Dhaain (Keerithi Maha Rehendi) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
- Primary inferred claim row: CLM-0482
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p19-p27-aunt-uncle-niece-nephew.md.
