...
Edge key: `kin|P108|P31|grandparent`  
...
- Pair summary: P108 Kulhiveri Hilaal Kaiulhanna Kaloge and P31 Ibrahim (Dhammaru Veeru) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P30 Hassan (Bavana) and P30 Hassan (Bavana) -> target parent links, P108 Kulhiveri Hilaal Kaiulhanna Kaloge is modeled as inferred grandparent-line kin of P31 Ibrahim (Dhammaru Veeru).
...
- Primary inferred claim row: CLM-0015
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p108-p31-grandparent.md).
