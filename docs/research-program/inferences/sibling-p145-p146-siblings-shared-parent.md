...
Edge key: `sibling|P145|P146|siblings (shared parent)`  
...
- Pair summary: P145 Ibrahim Nasir (son of President Ibrahim Nasir) and P146 Ismail Nasir are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P115 Ibrahim Nasir, P145 Ibrahim Nasir (son of President Ibrahim Nasir) and P146 Ismail Nasir are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0395
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p145-p146-siblings-shared-parent.md).
