...
Edge key: `kin|P196|P40|grandparent`  
...
- Pair summary: P196 Reccy and P40 Aboobakuru (Bavana Sooja) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P193 Princess Recca and P193 Princess Recca -> target parent links, P196 Reccy is modeled as inferred grandparent-line kin of P40 Aboobakuru (Bavana Sooja).
