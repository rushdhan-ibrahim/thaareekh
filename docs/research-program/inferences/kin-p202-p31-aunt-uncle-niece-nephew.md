...
Edge key: `kin|P31|P202|aunt/uncle↔niece/nephew`  
...
- Pair summary: P31 Ibrahim (Dhammaru Veeru) and P202 Kamba Dio are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P40 Aboobakuru (Bavana Sooja), P31 Ibrahim (Dhammaru Veeru)) plus parent(P40 Aboobakuru (Bavana Sooja), child) yields inferred aunt/uncle-line kin between P31 Ibrahim (Dhammaru Veeru) and P202 Kamba Dio.
...
- Primary inferred claim row: CLM-0493
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p202-p31-aunt-uncle-niece-nephew.md.
