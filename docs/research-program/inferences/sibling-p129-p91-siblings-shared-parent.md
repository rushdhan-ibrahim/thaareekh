...
Edge key: `sibling|P129|P91|siblings (shared parent)`  
...
- Pair summary: P129 Princess Veyogey Dhon Goma and P91 Mohamed Shamsuddine III (Kula Sundhura Katthiri) are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
3. Rule application (shared-parent-sibling): because both endpoints share parent P87 Ibrahim Nooredine (Keerithi Maha Radun), P129 Princess Veyogey Dhon Goma and P91 Mohamed Shamsuddine III (Kula Sundhura Katthiri) are modeled as inferred sibling-line kin.
