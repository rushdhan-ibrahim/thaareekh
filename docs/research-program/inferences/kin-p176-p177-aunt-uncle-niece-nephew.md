...
Edge key: `kin|P176|P177|aunt/uncle↔niece/nephew`  
...
- Pair summary: P176 Fathimath Saudha and P177 Yasmin Muizzu are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P172 Mohamed Muizzu, P176 Fathimath Saudha) plus parent(P172 Mohamed Muizzu, child) yields inferred aunt/uncle-line kin between P176 Fathimath Saudha and P177 Yasmin Muizzu.
...
- Primary inferred claim row: CLM-0113
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p176-p177-aunt-uncle-niece-nephew.md).
