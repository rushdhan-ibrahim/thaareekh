...
- Pair summary: P16 Salis (Meesuvvara) and P19 Ahmed Shihabuddine (Loka Aadheeththa) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
