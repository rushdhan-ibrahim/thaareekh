...
- Pair summary: P41 Hadi Hassan (Raadha Veeru) and P46 Omar (Loka Sundhura) are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
- Primary inferred claim row: CLM-0638
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/sibling-p41-p46-siblings-shared-parent.md.
