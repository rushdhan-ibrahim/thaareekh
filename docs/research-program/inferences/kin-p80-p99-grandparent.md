...
Edge key: `kin|P80|P99|grandparent`  
...
- Pair summary: P80 Hassan Izzuddine (Kula Ran Meeba Audha) and P99 Hussain Daharadha Thakurufan are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
- Historical/dynastic context: Huraagey -> Hilaaly
...
4. Rule application (parent-of-parent-grandparent): with source -> P100 Mohamed Faamuladeyri Thakurufan and P100 Mohamed Faamuladeyri Thakurufan -> target parent links, P80 Hassan Izzuddine (Kula Ran Meeba Audha) is modeled as inferred grandparent-line kin of P99 Hussain Daharadha Thakurufan.
