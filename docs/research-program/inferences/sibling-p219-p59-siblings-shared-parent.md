...
Edge key: `sibling|P59|P219|siblings (shared parent)`  
...
- Pair summary: P59 Hassan of Shiraz (Ram Mani Loka) and P219 Umar Ma'afai Kilege are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
3. Supporting edge: parent P51 Kalu Mohamed (Dhammaru Bavana) -> P219 Umar Ma'afai Kilege (CLM-0603, SRC-ROYALARK-MALDIVES, grade B); excerpt: Direct parent relation recorded between Kalu Mohamed as parent of Umar Ma'afai Kilege.
4. Rule application (shared-parent-sibling): because both endpoints share parent P51 Kalu Mohamed (Dhammaru Bavana), P59 Hassan of Shiraz (Ram Mani Loka) and P219 Umar Ma'afai Kilege are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0635
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/sibling-p219-p59-siblings-shared-parent.md.
