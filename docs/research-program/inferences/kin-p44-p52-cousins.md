...
- Pair summary: P44 Mohamed (Bavana Abarana) and P52 Yoosuf (Veeru Aanandha) are modeled as inferred kin (cousins) through rule `children-of-siblings-cousin`.
...
4. Rule application (children-of-siblings-cousin): children of sibling parents P41 Hadi Hassan (Raadha Veeru) and P46 Omar (Loka Sundhura) are modeled as inferred cousin-line kin (P44 Mohamed (Bavana Abarana) <-> P52 Yoosuf (Veeru Aanandha)).
...
- Primary inferred claim row: CLM-0565
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p44-p52-cousins.md.
