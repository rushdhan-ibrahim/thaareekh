...
Edge key: `kin|P208|P61|aunt/uncle↔niece/nephew`  
...
- Pair summary: P208 Princess Aysha Rani Kilege and P61 Hassan IX / Dom Manoel (Dhirikusa Loka) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P220 Ahmad Manikufa'anu Kalaminja, P208 Princess Aysha Rani Kilege) plus parent(P220 Ahmad Manikufa'anu Kalaminja, child) yields inferred aunt/uncle-line kin between P208 Princess Aysha Rani Kilege and P61 Hassan IX / Dom Manoel (Dhirikusa Loka).
...
- Primary inferred claim row: CLM-0510
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p208-p61-aunt-uncle-niece-nephew.md.
