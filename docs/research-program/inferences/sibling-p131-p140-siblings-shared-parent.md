...
Edge key: `sibling|P131|P140|siblings (shared parent)`  
...
- Target node: P140 Al-Nabeel Karayye Hassan Didi
- Label: siblings (shared parent)
- Current confidence marker (`c/i/u`): i
- Current grade (`A/B/C/D`): C

## 2) Why this specific pair is modeled
- Pair summary: P131 Mohamed Didi and P140 Al-Nabeel Karayye Hassan Didi are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P130 Prince Ibrahim Faamuladheyri Kilegefaanu, P131 Mohamed Didi and P140 Al-Nabeel Karayye Hassan Didi are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0384
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p131-p140-siblings-shared-parent.md).
