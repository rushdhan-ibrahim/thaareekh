...
Edge key: `kin|P13|P17|grandparent`  
...
- Pair summary: P13 Audha (Areedha Suvara) and P17 Davud (Sundhura Bavana) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
3. Rule application (parent-of-parent-grandparent): with source -> P15 Yoosuf (Bavanaadheeththa) and P15 Yoosuf (Bavanaadheeththa) -> target parent links, P13 Audha (Areedha Suvara) is modeled as inferred grandparent-line kin of P17 Davud (Sundhura Bavana).
...
- Primary inferred claim row: CLM-0059
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p13-p17-grandparent.md).
