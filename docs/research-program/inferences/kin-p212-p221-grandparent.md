...
Edge key: `kin|P221|P212|grandparent`  
...
- Pair summary: P221 Golavehi Aisha Rani Kilege and P212 Dona Catarina de Malvidas are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
3. Supporting edge: parent P61 Hassan IX / Dom Manoel (Dhirikusa Loka) -> P212 Dona Catarina de Malvidas (CLM-0608, SRC-ROYALARK-M16, grade B); excerpt: RoyalArk lineage entry under Dom Manoel lists Dona Catarina de Malvidas as a daughter in the same Dom Manoel and Dona Leonor de Ataide branch.
4. Rule application (parent-of-parent-grandparent): with source -> P61 Hassan IX / Dom Manoel (Dhirikusa Loka) and P61 Hassan IX / Dom Manoel (Dhirikusa Loka) -> target parent links, P221 Golavehi Aisha Rani Kilege is modeled as inferred grandparent-line kin of P212 Dona Catarina de Malvidas.
...
- Primary inferred claim row: CLM-0531
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p212-p221-grandparent.md.
