...
- Current adjudication state: deferred in manual batch-L pending at least one independent non-MRF corroboration source (contradiction-log CLOG-2026-02-08-C2).
- Immediate direct-claim anchors around these nodes:
- claim-id-missing: sibling P91 Mohamed Shamsuddine III (Kula Sundhura Katthiri) <-> P129 Princess Veyogey Dhon Goma [half-siblings (shared mother P185)] (SRC-ROYALARK-MALDIVES, grade B)
...
2. - parent P87 Ibrahim Nooredine (Keerithi Maha Radun) -> P91 Mohamed Shamsuddine III (Kula Sundhura Katthiri) (CLM-0366, SRC-MRF-KINGS)
3. - sibling P91 Mohamed Shamsuddine III (Kula Sundhura Katthiri) <-> P129 Princess Veyogey Dhon Goma [half-siblings (shared mother P185)] (claim-id-missing, SRC-ROYALARK-MALDIVES)
...
- Manual batch-L note (2026-02-19): CLM-0364 deferred until independent corroboration is added beyond the current MRF source family.
