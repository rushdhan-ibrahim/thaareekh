...
Edge key: `kin|P108|P39|grandparent`  
...
- Pair summary: P108 Kulhiveri Hilaal Kaiulhanna Kaloge and P39 Yoosuf (Loka Aananadha) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P30 Hassan (Bavana) and P30 Hassan (Bavana) -> target parent links, P108 Kulhiveri Hilaal Kaiulhanna Kaloge is modeled as inferred grandparent-line kin of P39 Yoosuf (Loka Aananadha).
...
- Primary inferred claim row: CLM-0017
