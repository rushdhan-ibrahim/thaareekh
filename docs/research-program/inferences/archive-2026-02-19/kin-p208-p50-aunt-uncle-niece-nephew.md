...
4. Under this canonical chain, P50 is nephew of P51, and P208 is child of P51; therefore P50 and P208 are generation-peers (cousin-line), not aunt/uncle↔niece/nephew.
5. Canonical decision for CLM-0506 is deferred pending model correction from aunt/uncle to cousin-line.
...
- Correction requirement: replace this edge with a cousin-line claim between P50 and P208 using canonical parentage anchors.
...
- Canonical promotion candidate: no (manual batch-H sets CLM-0506 to deferred pending edge-class correction).
