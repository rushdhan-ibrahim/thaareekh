...
Edge key: `kin|P50|P220|aunt/uncle↔niece/nephew`  
...
- Pair summary: P50 Ibrahim (Bavana Furasuddha) and P220 Ahmad Manikufa'anu Kalaminja are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Under this canonical chain, P50 is nephew of P51, and P220 is child of P51; therefore P50 and P220 are generation-peers (cousin-line), not aunt/uncle↔niece/nephew.
5. Canonical decision for CLM-0548 is deferred pending model correction from aunt/uncle to cousin-line.
...
- Correction requirement: replace this edge with a cousin-line claim between P50 and P220 using canonical parentage anchors.
...
- Primary inferred claim row: CLM-0548
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p220-p50-aunt-uncle-niece-nephew.md.

## 7) Integration notes
- Rule metadata source: `edge.inference_basis` + `edge.inference_rule` on research dataset edge.
- Canonical promotion candidate: no (manual batch-H sets CLM-0548 to deferred pending edge-class correction).
