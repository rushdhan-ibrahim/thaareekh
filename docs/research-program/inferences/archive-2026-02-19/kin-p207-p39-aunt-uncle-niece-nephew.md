...
Edge key: `kin|P39|P207|aunt/uncle↔niece/nephew`  
...
- Pair summary: P39 Yoosuf (Loka Aananadha) and P207 Recca are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P40 Aboobakuru (Bavana Sooja), P39 Yoosuf (Loka Aananadha)) plus parent(P40 Aboobakuru (Bavana Sooja), child) yields inferred aunt/uncle-line kin between P39 Yoosuf (Loka Aananadha) and P207 Recca.
...
- Primary inferred claim row: CLM-0500
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p207-p39-aunt-uncle-niece-nephew.md.
