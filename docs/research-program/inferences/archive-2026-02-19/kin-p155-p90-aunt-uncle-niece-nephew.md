...
Edge key: `kin|P155|P90|aunt/uncle↔niece/nephew`  
...
- Pair summary: P155 Maandhoogey Bodu Dhorhy Manippulu and P90 Mohamed Imaduddine V (Keerithi Maha Radun) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
- Primary inferred claim row: CLM-0097
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p155-p90-aunt-uncle-niece-nephew.md).
