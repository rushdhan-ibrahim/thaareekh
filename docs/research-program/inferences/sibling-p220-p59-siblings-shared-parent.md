...
Edge key: `sibling|P59|P220|siblings (shared parent)`  
...
- Pair summary: P59 Hassan of Shiraz (Ram Mani Loka) and P220 Ahmad Manikufa'anu Kalaminja are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P51 Kalu Mohamed (Dhammaru Bavana), P59 Hassan of Shiraz (Ram Mani Loka) and P220 Ahmad Manikufa'anu Kalaminja are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0636
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/sibling-p220-p59-siblings-shared-parent.md.
