...
Edge key: `kin|P52|P50|aunt/uncle↔niece/nephew`  
...
- Pair summary: P52 Yoosuf (Veeru Aanandha) and P50 Ibrahim (Bavana Furasuddha) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P47 Hassan (Raadha Aanandha), P52 Yoosuf (Veeru Aanandha)) plus parent(P47 Hassan (Raadha Aanandha), child) yields inferred aunt/uncle-line kin between P52 Yoosuf (Veeru Aanandha) and P50 Ibrahim (Bavana Furasuddha).
...
- Primary inferred claim row: CLM-0568
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p50-p52-aunt-uncle-niece-nephew.md.
