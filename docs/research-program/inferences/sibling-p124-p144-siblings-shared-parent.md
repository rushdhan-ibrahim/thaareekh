...
Edge key: `sibling|P124|P144|siblings (shared parent)`  
...
- Pair summary: P124 Ali Nasir and P144 Mohamed Nasir are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P115 Ibrahim Nasir, P124 Ali Nasir and P144 Mohamed Nasir are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0377
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p124-p144-siblings-shared-parent.md).
