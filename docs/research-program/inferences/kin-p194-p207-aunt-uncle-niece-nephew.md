...
Edge key: `kin|P207|P194|aunt/uncle↔niece/nephew`  
...
- Pair summary: P207 Recca and P194 Burecca are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P193 Princess Recca, P207 Recca) plus parent(P193 Princess Recca, child) yields inferred aunt/uncle-line kin between P207 Recca and P194 Burecca.
...
- Primary inferred claim row: CLM-0486
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p194-p207-aunt-uncle-niece-nephew.md.
