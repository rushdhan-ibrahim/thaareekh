...
- Primary inferred claim row: CLM-0089
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p151-p198-aunt-uncle-niece-nephew.md).
