...
Edge key: `kin|P47|P220|aunt/uncle↔niece/nephew`  
...
- Pair summary: P47 Hassan (Raadha Aanandha) and P220 Ahmad Manikufa'anu Kalaminja are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P51 Kalu Mohamed (Dhammaru Bavana), P47 Hassan (Raadha Aanandha)) plus parent(P51 Kalu Mohamed (Dhammaru Bavana), child) yields inferred aunt/uncle-line kin between P47 Hassan (Raadha Aanandha) and P220 Ahmad Manikufa'anu Kalaminja.
...
- Primary inferred claim row: CLM-0547
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p220-p47-aunt-uncle-niece-nephew.md.
