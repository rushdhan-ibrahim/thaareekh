...
- Pair summary: P44 Mohamed (Bavana Abarana) and P47 Hassan (Raadha Aanandha) are modeled as inferred kin (cousins) through rule `children-of-siblings-cousin`.
...
4. Rule application (children-of-siblings-cousin): children of sibling parents P41 Hadi Hassan (Raadha Veeru) and P46 Omar (Loka Sundhura) are modeled as inferred cousin-line kin (P44 Mohamed (Bavana Abarana) <-> P47 Hassan (Raadha Aanandha)).
...
- Primary inferred claim row: CLM-0563
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p44-p47-cousins.md.
