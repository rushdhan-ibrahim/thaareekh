...
Edge key: `kin|P120|P152|grandparent`  
...
- Pair summary: P120 Abdul Gayoom Ibrahim and P152 Faris Maumoon are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P119 Maumoon Abdul Gayoom and P119 Maumoon Abdul Gayoom -> target parent links, P120 Abdul Gayoom Ibrahim is modeled as inferred grandparent-line kin of P152 Faris Maumoon.
...
- Primary inferred claim row: CLM-0042
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p120-p152-grandparent.md).
