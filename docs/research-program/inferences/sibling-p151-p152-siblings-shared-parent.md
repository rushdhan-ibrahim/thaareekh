...
Edge key: `sibling|P151|P152|siblings (shared parent)`  
...
- Pair summary: P151 Yumna Maumoon and P152 Faris Maumoon are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P119 Maumoon Abdul Gayoom, P151 Yumna Maumoon and P152 Faris Maumoon are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0403
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p151-p152-siblings-shared-parent.md).
