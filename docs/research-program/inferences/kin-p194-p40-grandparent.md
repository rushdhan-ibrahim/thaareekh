...
- Primary inferred claim row: CLM-0135
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p194-p40-grandparent.md).
