...
Edge key: `sibling|P209|P212|siblings (shared parent)`  
...
- Pair summary: P209 Dom Francisco de Malvidas and P212 Dona Catarina de Malvidas are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P61 Hassan IX / Dom Manoel (Dhirikusa Loka), P209 Dom Francisco de Malvidas and P212 Dona Catarina de Malvidas are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0624
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/sibling-p209-p212-siblings-shared-parent.md.
