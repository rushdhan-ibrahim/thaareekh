...
Edge key: `sibling|P143|P144|siblings (shared parent)`  
...
- Pair summary: P143 Ahmed Nasir and P144 Mohamed Nasir are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P115 Ibrahim Nasir, P143 Ahmed Nasir and P144 Mohamed Nasir are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0388
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p143-p144-siblings-shared-parent.md).
