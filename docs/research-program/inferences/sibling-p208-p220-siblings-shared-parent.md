...
Edge key: `sibling|P208|P220|siblings (shared parent)`  
...
- Pair summary: P208 Princess Aysha Rani Kilege and P220 Ahmad Manikufa'anu Kalaminja are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P51 Kalu Mohamed (Dhammaru Bavana), P208 Princess Aysha Rani Kilege and P220 Ahmad Manikufa'anu Kalaminja are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0620
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/sibling-p208-p220-siblings-shared-parent.md.
