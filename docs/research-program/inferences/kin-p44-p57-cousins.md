...
- Pair summary: P44 Mohamed (Bavana Abarana) and P57 Ali (Aanandha) are modeled as inferred kin (cousins) through rule `children-of-siblings-cousin`.
...
4. Rule application (children-of-siblings-cousin): children of sibling parents P41 Hadi Hassan (Raadha Veeru) and P193 Princess Recca are modeled as inferred cousin-line kin (P44 Mohamed (Bavana Abarana) <-> P57 Ali (Aanandha)).
...
- Primary inferred claim row: CLM-0166
- Inferred claim locator: Inference basis: children-of-siblings-cousin (see docs/research-program/inferences/kin-p44-p57-cousins.md).
