...
Edge key: `kin|P51|P55|aunt/uncle↔niece/nephew`  
...
- Pair summary: P51 Kalu Mohamed (Dhammaru Bavana) and P55 Hassan (Singa Veeru) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P52 Yoosuf (Veeru Aanandha), P51 Kalu Mohamed (Dhammaru Bavana)) plus parent(P52 Yoosuf (Veeru Aanandha), child) yields inferred aunt/uncle-line kin between P51 Kalu Mohamed (Dhammaru Bavana) and P55 Hassan (Singa Veeru).
...
- Primary inferred claim row: CLM-0173
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p51-p55-aunt-uncle-niece-nephew.md).
