...
Edge key: `kin|P117|P146|grandparent`  
...
- Pair summary: P117 Nayaage Aishath Didi and P146 Ismail Nasir are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P115 Ibrahim Nasir and P115 Ibrahim Nasir -> target parent links, P117 Nayaage Aishath Didi is modeled as inferred grandparent-line kin of P146 Ismail Nasir.
...
- Primary inferred claim row: CLM-0036
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p117-p146-grandparent.md).
