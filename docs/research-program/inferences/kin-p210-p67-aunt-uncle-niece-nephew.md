...
- Pair summary: P210 Dom Pedro de Malvidas and P67 Philippe’ (Keerithi Maha Radun) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
- Primary inferred claim row: CLM-0521
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p210-p67-aunt-uncle-niece-nephew.md.
