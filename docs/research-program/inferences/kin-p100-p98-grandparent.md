...
- Primary inferred claim row: CLM-0004
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p100-p98-grandparent.md).
