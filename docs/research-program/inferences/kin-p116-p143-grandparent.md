...
Edge key: `kin|P116|P143|grandparent`  
...
- Pair summary: P116 Ahmed Didi and P143 Ahmed Nasir are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P115 Ibrahim Nasir and P115 Ibrahim Nasir -> target parent links, P116 Ahmed Didi is modeled as inferred grandparent-line kin of P143 Ahmed Nasir.
...
- Primary inferred claim row: CLM-0026
