...
Edge key: `kin|P220|P211|grandparent`  
...
- Pair summary: P220 Ahmad Manikufa'anu Kalaminja and P211 Dona Leonor de Malvidas are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P61 Hassan IX / Dom Manoel (Dhirikusa Loka) and P61 Hassan IX / Dom Manoel (Dhirikusa Loka) -> target parent links, P220 Ahmad Manikufa'anu Kalaminja is modeled as inferred grandparent-line kin of P211 Dona Leonor de Malvidas.
...
- Primary inferred claim row: CLM-0524
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p211-p220-grandparent.md.
