...
Edge key: `sibling|P150|P153|siblings (shared parent)`  
...
- Pair summary: P150 Dunya Maumoon and P153 Ghassan Maumoon are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P119 Maumoon Abdul Gayoom, P150 Dunya Maumoon and P153 Ghassan Maumoon are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0402
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p150-p153-siblings-shared-parent.md).
