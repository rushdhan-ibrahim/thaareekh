...
- Primary inferred claim row: CLM-0066
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p130-p78-grandparent.md).
