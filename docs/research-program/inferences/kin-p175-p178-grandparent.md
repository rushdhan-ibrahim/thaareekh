...
Edge key: `kin|P175|P178|grandparent`  
...
- Pair summary: P175 Husna Adam Ismail Manik and P178 Umair Muizzu are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P172 Mohamed Muizzu and P172 Mohamed Muizzu -> target parent links, P175 Husna Adam Ismail Manik is modeled as inferred grandparent-line kin of P178 Umair Muizzu.
...
- Primary inferred claim row: CLM-0111
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p175-p178-grandparent.md).
