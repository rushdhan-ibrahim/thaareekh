...
Edge key: `kin|P86|P90|grandparent`  
...
- Pair summary: P86 Mohamed Imaduddine (Kula Sudha Ira Siyaaaka) and P90 Mohamed Imaduddine V (Keerithi Maha Radun) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
3. Supporting edge: parent P87 Ibrahim Nooredine (Keerithi Maha Radun) -> P90 Mohamed Imaduddine V (Keerithi Maha Radun) (CLM-0365, SRC-MRF-KINGS, grade B); excerpt: Maldives Kings List family/genealogy content lists P87 Ibrahim Nooredine as parent of P90 Mohamed Imaduddine V.
...
- Primary inferred claim row: CLM-0206
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p86-p90-grandparent.md).
