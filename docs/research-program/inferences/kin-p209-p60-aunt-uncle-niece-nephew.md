...
- Pair summary: P60 Mohamed (Singa Bavana) and P209 Dom Francisco de Malvidas are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
- Primary inferred claim row: CLM-0514
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p209-p60-aunt-uncle-niece-nephew.md.
