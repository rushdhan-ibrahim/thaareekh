...
Edge key: `kin|P213|P98|grandparent`  
...
- Pair summary: P213 Infanta Dona Ines de Malvidas and P98 Dom Maraduru Fandiaiy Thakurufan are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P97 Dom Luis de Sousa and P97 Dom Luis de Sousa -> target parent links, P213 Infanta Dona Ines de Malvidas is modeled as inferred grandparent-line kin of P98 Dom Maraduru Fandiaiy Thakurufan.
...
- Primary inferred claim row: CLM-0536
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p213-p98-grandparent.md.
