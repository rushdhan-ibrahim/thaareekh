...
- Primary inferred claim row: CLM-0124
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p190-p91-aunt-uncle-niece-nephew.md).
