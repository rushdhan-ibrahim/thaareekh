...
Edge key: `kin|P202|P196|aunt/uncle↔niece/nephew`  
...
- Pair summary: P202 Kamba Dio and P196 Reccy are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
3. Rule application (parent-sibling-aunt-uncle): sibling(P193 Princess Recca, P202 Kamba Dio) plus parent(P193 Princess Recca, child) yields inferred aunt/uncle-line kin between P202 Kamba Dio and P196 Reccy.
...
- Primary inferred claim row: CLM-0488
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p196-p202-aunt-uncle-niece-nephew.md.
