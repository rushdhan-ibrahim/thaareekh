...
Edge key: `kin|P217|P39|grandparent`  
...
- Pair summary: P217 Dori Kuja and P39 Yoosuf (Loka Aananadha) are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P30 Hassan (Bavana) and P30 Hassan (Bavana) -> target parent links, P217 Dori Kuja is modeled as inferred grandparent-line kin of P39 Yoosuf (Loka Aananadha).
...
- Primary inferred claim row: CLM-0538
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p217-p39-grandparent.md.
