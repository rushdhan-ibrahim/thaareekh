...
Edge key: `kin|P14|P16|aunt/uncle↔niece/nephew`  
...
- Target node: P16 Salis (Meesuvvara)
- Label: aunt/uncle↔niece/nephew
- Current confidence marker (`c/i/u`): i
- Current grade (`A/B/C/D`): C

## 2) Why this specific pair is modeled
- Pair summary: P14 Hali (Areedha Suvara) and P16 Salis (Meesuvvara) are modeled as inferred kin (aunt/uncle↔niece/nephew) through rule `parent-sibling-aunt-uncle`.
...
4. Rule application (parent-sibling-aunt-uncle): sibling(P15 Yoosuf (Bavanaadheeththa), P14 Hali (Areedha Suvara)) plus parent(P15 Yoosuf (Bavanaadheeththa), child) yields inferred aunt/uncle-line kin between P14 Hali (Areedha Suvara) and P16 Salis (Meesuvvara).
...
- Primary inferred claim row: CLM-0077
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p14-p16-aunt-uncle-niece-nephew.md).
