...
- Primary inferred claim row: CLM-0069
- Inferred claim locator: Inference basis: parent-of-parent-grandparent (see docs/research-program/inferences/kin-p131-p81-grandparent.md).
