...
Edge key: `kin|P119|P135|grandparent`  
Last updated: `2026-02-08`  
Inference class: `rule-derived`

## 1) Edge identity
- Relation type: kin
- Source node: P119 Maumoon Abdul Gayoom
...
- Pair summary: P119 Maumoon Abdul Gayoom and P135 Galolhu Sitti are modeled as inferred kin (grandparent) through rule `parent-of-parent-grandparent`.
...
4. Rule application (parent-of-parent-grandparent): with source -> P120 Abdul Gayoom Ibrahim and P120 Abdul Gayoom Ibrahim -> target parent links, P119 Maumoon Abdul Gayoom is modeled as inferred grandparent-line kin of P135 Galolhu Sitti.
