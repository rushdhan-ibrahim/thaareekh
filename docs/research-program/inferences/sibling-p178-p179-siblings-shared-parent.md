...
Edge key: `sibling|P178|P179|siblings (shared parent)`  
Last updated: `2026-02-10`  
Inference class: `rule-derived`

## 1) Edge identity
- Relation type: sibling
- Source node: P178 Umair Muizzu
...
- Pair summary: P178 Umair Muizzu and P179 Zaid Muizzu are modeled as inferred sibling (siblings (shared parent)) through rule `shared-parent-sibling`.
...
4. Rule application (shared-parent-sibling): because both endpoints share parent P172 Mohamed Muizzu, P178 Umair Muizzu and P179 Zaid Muizzu are modeled as inferred sibling-line kin.
...
- Primary inferred claim row: CLM-0416
- Inferred claim locator: Inference basis: shared-parent-sibling (see docs/research-program/inferences/sibling-p178-p179-siblings-shared-parent.md).
