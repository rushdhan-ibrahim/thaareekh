...
- Pair summary: P49 Sheikh Hassan (Raadha Fanaveeru) and P194 Burecca are modeled as inferred kin (cousins) through rule `children-of-siblings-cousin`.
...
4. Rule application (children-of-siblings-cousin): children of sibling parents P202 Kamba Dio and P193 Princess Recca are modeled as inferred cousin-line kin (P49 Sheikh Hassan (Raadha Fanaveeru) <-> P194 Burecca).
...
- Primary inferred claim row: CLM-0487
- Inferred claim locator: Inference basis documented in docs/research-program/inferences/kin-p194-p49-cousins.md.
