...
- Primary inferred claim row: CLM-0062
- Inferred claim locator: Inference basis: parent-sibling-aunt-uncle (see docs/research-program/inferences/kin-p13-p8-aunt-uncle-niece-nephew.md).
