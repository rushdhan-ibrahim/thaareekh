...
- [x] Research QA pipeline runtime reduction >= 50% (warm-lane Rust vs Node speedup: `6.116x`).
- [ ] Research QA cold-start runtime parity (cold-lane Rust vs Node speedup: `0.510x`).
